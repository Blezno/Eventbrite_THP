...
class AttendancesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create attendance" do
    assert_difference("Attendance.count") do
      post attendances_url, params: { attendance: { stripe_costumer_id: @attendance.stripe_costumer_id } }
    end
  ...
  test "should update attendance" do
    patch attendance_url(@attendance), params: { attendance: { stripe_costumer_id: @attendance.stripe_costumer_id } }
